...
public class TestUtils {
    ...
    static Script bundleStandard(String filePath, IResolver resolver, IResourceLoader loader) throws ModuleLoaderException {
        return Bundler.bundle(Paths.get(filePath), resolver, loader);
    }

    static Script bundleTree(String filePath, IResolver resolver, IResourceLoader loader) throws ModuleLoaderException {
        return Bundler.bundleWithTreeShaking(Paths.get(filePath), resolver, loader);
    }
